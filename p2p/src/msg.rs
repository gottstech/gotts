...
/// Gotts's user agent with current version
pub const USER_AGENT: &'static str = concat!("MW/Gotts ", env!("CARGO_PKG_VERSION"));

/// Magic numbers expected in the header of every message
const OTHER_MAGIC: [u8; 2] = [71, 43];
const FLOONET_MAGIC: [u8; 2] = [82, 59];
const MAINNET_MAGIC: [u8; 2] = [93, 67];
