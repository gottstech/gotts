...
fn comments() -> HashMap<String, String> {
	...
	retval.insert(
		"[server]".to_string(),
		"
# Generated Server Configuration File for Gotts
#
# When running the gotts executable without specifying any command line
...
#real mining should use the standalone gotts-miner
"
		.to_string(),
	);
