...
use gotts_chain::{BlockStatus, ChainAdapter, Options};
...
fn test_block_a_block_b_block_b_fork_header_c_fork_block_c() {
	let chain_dir = ".gotts.block_a_block_b_block_b_fork_header_c_fork_block_c";
	clean_output_dir(chain_dir);
...
fn test_block_a_block_b_block_b_fork_header_c_fork_block_c_fork() {
	let chain_dir = ".gotts.block_a_block_b_block_b_fork_header_c_fork_block_c_fork";
	clean_output_dir(chain_dir);
	global::set_mining_mode(ChainTypes::AutomatedTesting);
	let kc = ExtKeychain::from_random_seed(false).unwrap();
	let genesis = pow::mine_genesis_block().unwrap();
...
fn test_block_a_header_b_header_b_fork_block_b_fork_block_b_block_c() {
	let chain_dir = ".gotts.test_block_a_header_b_header_b_fork_block_b_fork_block_b_block_c";
	clean_output_dir(chain_dir);
	global::set_mining_mode(ChainTypes::AutomatedTesting);
	let kc = ExtKeychain::from_random_seed(false).unwrap();
	let genesis = pow::mine_genesis_block().unwrap();
...
fn test_block_a_header_b_header_b_fork_block_b_fork_block_b_block_c_fork() {
	let chain_dir = ".gotts.test_block_a_header_b_header_b_fork_block_b_fork_block_b_block_c_fork";
	clean_output_dir(chain_dir);
	global::set_mining_mode(ChainTypes::AutomatedTesting);
	let kc = ExtKeychain::from_random_seed(false).unwrap();
	let genesis = pow::mine_genesis_block().unwrap();
...
fn mine_reorg() {
	...
	const DIR_NAME: &str = ".gotts_reorg";
	clean_output_dir(DIR_NAME);
...
fn mine_forks() {
	global::set_mining_mode(ChainTypes::AutomatedTesting);
	{
		let chain = init_chain(".gotts2", pow::mine_genesis_block().unwrap());
		let kc = ExtKeychain::from_random_seed(false).unwrap();
...
fn mine_losing_fork() {
	...
	let kc = ExtKeychain::from_random_seed(false).unwrap();
	{
		let chain = init_chain(".gotts3", pow::mine_genesis_block().unwrap());
...
fn longer_fork() {
	...
	let genesis = pow::mine_genesis_block().unwrap();
	{
		let chain = init_chain(".gotts4", genesis.clone());
