...
//! Main for building the binary of a Gotts peer-to-peer node.
...
use gotts_config as config;
use gotts_core as core;
use gotts_p2p as p2p;
use gotts_servers as servers;
...
pub fn info_strings() -> (String, String) {
	(
		format!(
			"This is Gotts version {}{}, built for {} by {}.",
...
fn real_main() -> i32 {
	...
	if chain_type == global::ChainTypes::Mainnet {
		println!("Mainnet not ready yet! In the meantime run 'gotts --floonet ...'");
		return 1;
	}
